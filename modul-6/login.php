...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $secretKey = '6LeIxAcTAAAAAGG-vFI1TnRWxMZNFuojJ4WifJWe'; // Kunci reCAPTCHA Test

    // Validasi captcha
    $captcha = verifyRecaptcha($secretKey, $recaptchaResponse);

    if (!$captcha || !$captcha->success) {
        $error = "Verifikasi reCAPTCHA gagal atau belum diisi.";
    } else {
...
<body>
    ...
    <div class="login-container">
        <div class="flex flex-col items-center mb-8">
            ...
            <h1 class="text-3xl font-bold text-gray-800 mb-2">Sistem Login Kantornya Arzha</h1>
